          ...
          <div className="mobileslider">
            ...
            >
              <div className="MobileDrawerHeader">
                <div>
                  <AccountCircleIcon style={styleForIcon} />
                </div>
                <div classNme="DrawerheaderUser">
              ...
              {togglehide ? (
                <div className="MobileDrawerlists">
                  <div className="MobileDrawerlist">
                    ...
                    {sidebarcontent?.map((d, i) => (
                      <div
                        key={i}
                        onClick={(e) => tooglehideDrawer(d, i)}
                        className="MobileDrawerlistItem"
                      >
                        <div>{d.category}</div>
                        <div>
                          <ArrowForwardIosIcon style={styleForArrow} />
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="MobileDrawerlists">
                  <div className="MobileDrawerlist">
                    <div
                      onClick={(e) => tooglehideDrawer()}
                      className="MobileDrawerMenu"
                    >
                      <button className="MobileDrawerMenuButton">
                        <ArrowBackIcon style={styleForMenuArrow} />{" "}
                        <p>Main Menu</p>
                      </button>
                    </div>
                  </div>
                      ...
                      {d.map((data) => (
                        <div className="MobileDrawerlist">
                          ...
                          {data.subcategorycomponent.map((sub) => (
                            <div onClick={e=> catergorysearcher(sub)} className="MobileDrawerlistItem">
                              <div >
                                {sub}
                              </div>
